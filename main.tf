resource "google_compute_firewall" "firewall_rule" {
  ...
  source_tags             = var.source_tags             # 소스 태그 목록
  source_service_accounts = var.source_service_accounts # 소스 서비스 계정 목록
  target_tags             = var.target_tags             # 대상 태그 목록
  target_service_accounts = var.target_service_accounts # 대상 서비스 계정 목록
